variable "aws_region" {
  description = "AWS region for workload account resources. Scopes the permissions boundary to this region — the agent will only read EKS, CloudWatch, ECR, and networking resources here."
  type        = string
  default     = "eu-west-2"
}
